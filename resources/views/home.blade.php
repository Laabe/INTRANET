                ...
                <div class="card-body">
                    <div class="row d-flex align-items-center">
                        <div class="col">
                            ...
                            <p class="text-muted fs-13 mb-0">My Annual Leaves</p>
                        </div>
                ...
                <div class="card-body">
                    <div class="row d-flex align-items-center">
                        <div class="col">
                            ...
                            <p class="text-muted fs-13 mb-0">My Holidays</p>
                        </div>
                        <div class="col col-auto top-icn">
                ...
                <div class="card-body">
                    <div class="row d-flex align-items-center">
                        <div class="col">
                            ...
                            <p class=" fs-13 mb-0">
                                <a href="" class="text-decoration-none text-muted">My Pending Requests</a>
                            </p>
                        </div>
                        <div class="col col-auto top-icn">
